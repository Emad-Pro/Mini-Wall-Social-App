...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ...
  final String uid = FirebaseAuth.instance.currentUser!.uid;
   ...
   await  FirebaseFirestore.instance
        ...
        .doc(uid)
        .get().then((value){
          emit(state.copyWith(profileModel: CustomProfileModel.fromJson(value.data()!),requestState: RequestState.success));
        }).catchError((onError){
          emit(state.copyWith(erorrMessage: onError.toString(),requestState: RequestState.erorr));
        });
  }
}
